...
assert.equal(html.match(/styles\.css\?v=(\d+)/)?.[1], "604", "HTML должен подключать styles.css?v=604");
assert(sw.includes('const CACHE_NAME = "budget-2a-v90-parent-navigation-1";'), "cache name должен быть обновлён для новой версии стилей");
