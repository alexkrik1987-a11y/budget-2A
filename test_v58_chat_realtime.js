...
assert(html.includes('app.js?v=79'), "index.html не обновил cache-busting app.js");
assert(sw.includes('budget-2a-shell-v84'), "sw.js не обновил PWA-кэш до v84");
assert(sw.includes('./app.js?v=79'), "sw.js не обновил app.js в shell-кэше");
