...
const EXPECTED_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-5";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=591", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=591", "/app.js?v=83"]) {
    operations.length = 0;
    networkRequests.length = 0;
