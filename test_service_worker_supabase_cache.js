...
const EXPECTED_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-10";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=595", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=595", "/app.js?v=84"]) {
    operations.length = 0;
    networkRequests.length = 0;
