...
const SW_URL = `${ORIGIN}/sw.js?v=94`;
const OLD_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-4";
const EXPECTED_CACHE_NAME = "budget-2a-v94-collector-journal-1";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=608", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=608", "/app.js?v=92"]) {
    operations.length = 0;
    networkRequests.length = 0;
