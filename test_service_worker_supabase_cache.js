...
const EXPECTED_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-13";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=598", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=598", "/app.js?v=84"]) {
    operations.length = 0;
    networkRequests.length = 0;
