...
const SW_URL = `${ORIGIN}/sw.js?v=93`;
const OLD_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-4";
const EXPECTED_CACHE_NAME = "budget-2a-v93-class-edition-1";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=607", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=607", "/app.js?v=91"]) {
    operations.length = 0;
    networkRequests.length = 0;
