...
const SW_URL = `${ORIGIN}/sw.js?v=90`;
const OLD_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-4";
const EXPECTED_CACHE_NAME = "budget-2a-v90-parent-navigation-1";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=604", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=604", "/app.js?v=88"]) {
    operations.length = 0;
    networkRequests.length = 0;
