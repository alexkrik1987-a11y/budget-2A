...
const OLD_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-3";
const EXPECTED_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-4";
...
async function main() {
  ...
  for (const path of ["/styles.css?v=590", "/app.js?v=83"]) {
    operations.length = 0;
    networkRequests.length = 0;
