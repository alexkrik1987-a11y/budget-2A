...
const SW_URL = `${ORIGIN}/sw.js?v=89`;
const OLD_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-4";
const EXPECTED_CACHE_NAME = "budget-2a-v89-household-funds-card-2";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=603", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=603", "/app.js?v=87"]) {
    operations.length = 0;
    networkRequests.length = 0;
