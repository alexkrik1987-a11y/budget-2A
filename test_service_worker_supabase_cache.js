...
const EXPECTED_CACHE_NAME = "budget-2a-v86-artistic-chalkboard-12";
...
async function main() {
  ...
  const staticUrl = new URL("/styles.css?v=597", ORIGIN).href;
  ...
  for (const path of ["/styles.css?v=597", "/app.js?v=84"]) {
    operations.length = 0;
    networkRequests.length = 0;
