...
assert(html.includes('styles.css?v=583'), "index.html не обновил cache-busting styles.css");
assert(fs.readFileSync("sw.js", "utf8").includes("budget-2a-shell-v79"), "sw.js не обновил PWA-кэш до v79");
