-- =========================================================
-- LEGACY / ИСТОРИЧЕСКИЙ ФАЙЛ — НЕ ЗАПУСКАТЬ ДЛЯ ТЕКУЩЕЙ УСТАНОВКИ И REPLAY.
-- Он сохранён только для истории и содержит старую объединённую миграцию.
-- Актуальный порядок отдельных SQL-файлов указан в README.md.
-- =========================================================
